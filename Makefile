# This Makefile is for the Render the Flickr Photos List extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     DISTNAME => q[FlickrPhotosList]
#     NAME => q[Render the Flickr Photos List]
#     PREREQ_PM => {  }
#     VERSION => q[1.0]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Render the Flickr Photos List
NAME_SYM = Render_the_Flickr_Photos_List
VERSION = 1.0
...
MAKE = make
FULLEXT = Render the Flickr Photos List
BASEEXT = List
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/FlickrPhotosList/Plugin.pm
...
TO_INST_PM = lib/FlickrPhotosList/Plugin.pm

PM_TO_BLIB = lib/FlickrPhotosList/Plugin.pm \
	blib/lib/FlickrPhotosList/Plugin.pm
...
DISTNAME = FlickrPhotosList
DISTVNAME = FlickrPhotosList-1.0
...
manifypods : pure_all  \
	lib/FlickrPhotosList/Plugin.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/FlickrPhotosList/Plugin.pm $(INST_MAN3DIR)/FlickrPhotosList::Plugin.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               FlickrPhotosList' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/FlickrPhotosList/Plugin.pm blib/lib/FlickrPhotosList/Plugin.pm 
